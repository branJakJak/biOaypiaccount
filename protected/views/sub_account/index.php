			...
			<div ng-show="selectedMainAccountKey !== null">
				...
				<table class="table table-hover table-bordered">
					...
					<tbody>
						...
						<tr  ng-repeat="(key, value) in currentSubAccounts" ng-show="currentSubAccounts.length !== 0">
						...
						<tr>
							...
							<td>
								<div class="btn-group">
									...
									<button type="button" class="btn btn-default" ng-click="indexCtrl.generateRandomSubAccount()">
										Generate Random
									</button>
								</div>								
							</td>
